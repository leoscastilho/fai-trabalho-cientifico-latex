...
# 1. Cria e entra no diretório do projeto
...
# 4. Cria links simbólicos (Symlinks) para a lógica central (Sempre em sincronia)
...
# 5. Copia o conteúdo inicial editável
echo "📄 Copiando arquivos de conteúdo (metadados, capítulos, etc.)..."
# Copia todos os arquivos .tex EXCETO o main.tex (que é um link simbólico)
...
echo "✅ Sucesso! O projeto '$PROJECT_NAME' está pronto."
echo ""
echo "Início Rápido:"
