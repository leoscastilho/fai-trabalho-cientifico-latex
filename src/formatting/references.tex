...
% Vírgula entre autor e ano. \addcomma é suprimido por biblatex quando o
% último sinal impresso foi um ponto (ex.: "et al."); nesse caso a vírgula
% é inserida explicitamente para obter "(AUTOR et al., 2025)".
\DeclareDelimFormat{nameyeardelim}{\ifpunctmark{.}{,\space}{\addcomma\space}}
...
\renewbibmacro*{name:family-given}[4]{%
  \ifuseprefix
    ...
    {\usebibmacro{name:delim}{#1}%
     ...
     \mkbibnamefamily{\MakeUppercase{#1}}\isdot
     \ifblank{#2}{}{\revsdnamepunct\bibnamedelimd\mkbibnamegiven{#2}\isdot}%
     % Partícula (de, da, dos...) após o prenome, conforme ABNT: SILVA, V. A. de
...
\DeclareFieldFormat{edition}{#1\adddot\space ed\adddot}
